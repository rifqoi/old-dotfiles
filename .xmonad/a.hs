...
normal_w_color = "#8B78AF"5                                -- Border color of normal windows
-- normal_w_color = "#232323"                                -- Border color of normal windows

focused_w_color :: String
focused_w_color = "#8B78AF"                               -- Border color of focused windows
...
myScratchPads = [ NS "terminal"  spawnTerm findTerm manageTerm
  ...
  where
    ...
    spawnTop   = terminal_emulator ++ " -t sysinfo -e bashtop"
...
--------------------------------------------------------------
    -- Xmonad
        ...
        -- [ ("M-C-r", spawn "killall xmobar; xmobar --recompile ;xmonad --recompile; xmonad --restart")  -- Recompiles xmonad
        , ("M-z"  , spawn (text_editor ++ " .xmonad/xmonad.hs") ) 
        , ("M-S-z", spawn (text_editor ++ " .config/xmobar/xmobar.hs") ) 
--------------------------------------------------------------
...
---------------------------------------------------------------
    -- Multimedia Keys
        ...
        [("M-C" ++ show(i), windows $ copy ws) | (i,ws) <- zip [1..9] workspace_names]
