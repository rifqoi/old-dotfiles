...
function dunsty_boi {
    ...
    dunstify  -h string:fgcolor:#999 '      ' -i $icon_name -r ${ID} -a ${APPNAME} "<span foreground='${color}' font_desc='Fira Code Nerd Font 20'><b>Brightness</b></span>\n<span foreground='${color}' font_desc='Source Code Pro 16'><b>$(bar_thingy)</b></span>"
}
