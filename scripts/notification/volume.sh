...
function dunsty_boi_up {
    ...
    #dunstify -i $icon_name -r ${ID} -a ${APPNAME} -h string:fgcolor:#ebe3ba -h string:frcolor:#ebe3ba $(bar_thingy) 
    #dunstify -h string:fgcolor:#2c2e3e '      ' -i $icon_name -r ${ID} -a ${APPNAME} "<span foreground='#caf6bb' font_desc='UbuntuMono Nerd Font 22'><b>Volume</b></span>\n<span foreground='#ebb9b9' font_desc='Source Code Pro 23'><b>$(bar_thingy)</b></span>"
    dunstify  -i $icon_name -r $ID -a $APPNAME -h string:bgcolor:#0f1213 -h string:frcolor:#4c566a -h string:fgcolor:#ccdce4 '      ' "<span foreground='#556A73' font_desc='Fira Code Nerd Font Italic 19'><b>Vo</b></span><span foreground='#9C7863' font_desc='Fira Code Nerd Font Italic 19'><b>lu</b></span><span foreground='#5A7988' font_desc='Fira Code Nerd Font Italic 19'><b>me</b></span>\n<span foreground='#ccdce4' font_desc='Material Icon Design 22'><b>$(bar_thingy)</b></span>"
}
    ...
    case "$1" in
        ...
        toggle)
            ...
            if [[ "$volume" == "muted" ]] ; then
                ...
                dunstify  -i $icon_name -r $ID -a $APPNAME -h string:bgcolor:#0f1213 -h string:frcolor:#4c566a -h string:fgcolor:#ccdce4 '      ' "<span foreground='#556A73' font_desc='Fira Code Nerd Font Italic 19'><b>Vo</b></span><span foreground='#9C7863' font_desc='Fira Code Nerd Font Italic 19'><b>lu</b></span><span foreground='#5A7988' font_desc='Fira Code Nerd Font Italic 19'><b>me</b></span>\n<span foreground='#ccdce4' font_desc='Material Icon Design 22'><b> D E D</b></span>"
            else
                dunsty_boi_up
                canberra-gtk-play -i audio-volume-change -d "changeVolume"
            fi
